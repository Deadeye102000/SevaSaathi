...
describe('Rules Engine & Intent Parser Unit Tests', () => {
  ...
  describe('parseUserIntent 3-Step Guided Flow vs Shortcut', () => {
    ...
    test('STEP 4: date given ("15 september se") with pendingLeaveType & pendingDays → triggers apply_leave', () => {
      const intentResult = parseUserIntent('15 september se', [], false, null, 'casual', 3);
